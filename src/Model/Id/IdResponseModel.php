...
class IdResponseModel extends AbstractModel implements ResponseModelInterface
{
     ...
     *
     * @SA\Type("array<wedocreatives\WrikePhpJmsserializer\Model\Id\IdResourceModel>")
     * @SA\SerializedName("data")
     *
     * @var array|IdResourceModel]|null
     */
    protected $data;
    ...
    /**
     * @return array|IdResourceModel[]|null
     */
    ...
    /**
     * @param array|IdResourceModel[]|null $data
     *
     * @return $this
     */
