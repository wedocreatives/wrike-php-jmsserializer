...
namespace wedocreatives\WrikePhpJmsserializer\Model\Color;
...
class ColorResponseModel extends AbstractModel implements ResponseModelInterface
{
     ...
     *
     * @SA\Type("array<wedocreatives\WrikePhpJmsserializer\Model\Color\ColorResourceModel>")
     * @SA\SerializedName("data")
     *
     * @var array|ColorResourceModel]|null
     */
    protected $data;
    ...
    /**
     * @return array|ColorResourceModel[]|null
     */
    ...
    /**
     * @param array|ColorResourceModel[]|null $data
     *
     * @return $this
     */
