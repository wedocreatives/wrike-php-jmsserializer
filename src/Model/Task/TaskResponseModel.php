...
class TaskResponseModel extends AbstractModel implements ResponseModelInterface
{
     ...
     *
     * @SA\Type("array<wedocreatives\WrikePhpJmsserializer\Model\Task\TaskResourceModel>")
     * @SA\SerializedName("data")
     *
     * @var array|TaskResourceModel]|null
     */
    protected $data;
    ...
    /**
     * @return array|TaskResourceModel[]|null
     */
    ...
    /**
     * @param array|TaskResourceModel[]|null $data
     *
     * @return $this
     */
